    ...
    <div className="brand-umbrella">
      <header className="static-page-header">
        <div className="container">
          <p className="eyebrow">Bar Catering</p>
      ...
      <section className="section">
        <div className="container catering-main-grid">
          <div className="catering-main-col">
            <h2>Choose Your Bar</h2>
            <p>
              Every bar is built around one of three packages. Specific items and pricing for each
              package are sent by email after you submit an inquiry.
            </p>
            <div className="catering-package-grid">
              ...
              <div className="catering-package-card">
                ...
                <p>
                  Includes 4 choices of beer, 3 wine varietals, and as many options of batched cocktails
                  as you&rsquo;d like.
                </p>
              </div>
              <div className="catering-package-card">
          ...
          <div className="catering-form-col">
            <div className="catering-form-section">
              <h2>Get a Quote</h2>
              <p>
                Fill out the inquiry form with your event details. We&rsquo;ll follow up by email with our
                full bar catering menu, pricing, and next steps.
              </p>
