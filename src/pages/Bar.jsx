        ...
        <div className="container two-col">
          ...
          <aside className="info-panel bar-panel">
            ...
            <dl>
              ...
              <div className="info-row"><dt>Hours</dt><dd>Evenings<br />Hours vary</dd></div>
      ...
      <section className="section-tight bar-section photo-strip-section">
        <div className="container">
          <div className="photo-strip">
            <img src={images.barNeon} alt="Neon sign glow at Marge's Bar" className="tall" />
            <img src={images.barPatio} alt="Shared patio between Marge's Bar and the Supper Club" />
            <img src={images.barCrowd} alt="Friends gathered for drinks at Marge's Bar" />
          </div>
        </div>
      </section>
